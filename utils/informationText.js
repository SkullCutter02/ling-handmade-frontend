export const whyChooseHandmadeSoap =
...
export const whyChooseLHM =
  ...
  "          to reduce manufacturing cost. We use high quality but affordable ingredients to make our products " +
  "          as we want to promote the use of natural skincare to the general public." +
  "          Majority of our products are scented with\n" +
  "          essential oils. In some cases, organic ones are used if it stays on the skin. For example: lipbalm, cream, and lotion." +
